...
NotificationLibrary:SendNotification("Warning", "Chúc bạn sài script vui vẻ ko quạo", 10)
...
function UpdatePlayerChams()
	for i,v in pairs(game:GetService'Người chơi':GetChildren()) do
		pcall(function()
...
local Window = Fluent:CreateWindow({
    Title = "Duahauhub| Blox Fruits",
    SubTitle = " Make by Bao_AN",
    TabWidth = 100,
...
local Tabs = {
    ...
    Qs = Window:AddTab({ Title = "Lấy item", Icon = "" }), 
    stack = Window:AddTab({ Title = "Stack Farming", Icon = "" }), 
    Se = Window:AddTab({ Title = "Săn sea", Icon = "" }),   
    St = Window:AddTab({ Title = "Server", Icon = "" }),    
    Lc = Window:AddTab({ Title = "Dịch chuyển", Icon = "" }),   
    spl = Window:AddTab({ Title = "Nâng chỉ số", Icon = "" }),   
    RC = Window:AddTab({ Title = "Up tộc", Icon = "" }),
    raid = Window:AddTab({ Title = "Địng vị", Icon = "" }),
    De = Window:AddTab({ Title = "Nhặt trái", Icon = "" }),    
...
function RedeemCode(value)
    ...
    Tabs.Main:AddParagraph({
        Title = "Kaitun hơi lỏ,
        Content = "Kaitun ko có farm lv và lấy item nhiều vì chx update :)) "
    })
...
spawn(function()
    ...
    Tabs.Lc:AddSection("Dịch chuyển")
    Tabs.Lc:AddButton({
...
spawn(function()
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Auto Bật haki vũ trang", Default = true })
...
local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Auto Bật haki quan sát", Default = false })
...
spawn(function()
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Mang quái", Default = true })
...
task.spawn(function()
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Xóa sương mù", Default = false })
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Bật v4", Default = false })
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto  cày Level", Default = false })
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Farm Quá gần", Default = false })
...
spawn(function()
    ...
    local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto Làm nhiệm vụ qua sea2", Default = false })
...
DropdownTweenSpeed:OnChanged(function(Value)
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto triệu hồi Katakuri", Default = true})
...
spawn(function()
    ...
    Toggle:OnChanged(function(Value)
        ...
        local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Đánh hải tặc ở Pháo", Default = false })
 ...
 local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Dừng nhặt rương khi có Key râu đen & Cup", Default = false})
...
spawn(function()
 ...
 local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Nhặt Rương", Default = false})
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Farm Rương┊Bypass", Default = false })
...
if _G.ChestBypass then
 ...
 local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Săn Elite", Default = false })
 ...
 local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Đánh Rip Indra", Default = false })
 ...
 spawn(function()
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Đánh boss lưỡi hái", Default = false })
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Farm Ectoplasm", Default = false })
  ...
  pcall(function()
   ...
   game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PurchaseRawFruit",_G.SelectFruit)
    ...
    local Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Địng vị trái", Default = false })
    ...
    local Dropdown = Tabs.raid:AddDropdown("Dropdown", {
        Title = "Chip",
        Values = {"Bóng tối","Cát","Magma","Lôi","Lửa","Băng","Ánh sáng","Trấn động","Phật tổ","lửa","Phoenix","Bột"},
        Multi = false,
        Default = 1,
    })
   ...
   local Toggle = Tabs.raid:AddToggle("MyToggle", {Title = "Mua chip", Default = false })
    Toggle:OnChanged(function(Value)
   _G.AutoBuyChip = Value
    ...
    local Toggle = Tabs.raid:AddToggle("MyToggle", {Title = "Qua đảo tiếp theo", Default = false })
    Toggle:OnChanged(function(Value)
...
local Toggle = Tabs.raid:AddToggle("MyToggle", {Title = "Kill quái raid", Default = false })
    Toggle:OnChanged(function(Value)
   _G.concubu = Value
		end)
...
local Toggle = Tabs.raid:AddToggle("MyToggle", {Title = "Thức tỉnh v2 trái", Default = false })
    Toggle:OnChanged(function(Value)
   _G.Auto_Awakener = Value
    ...
    local Timekl = Tabs.St:AddParagraph({
        Title = "Thời gian tham gia server",
        Content = ""
    })
...
game:GetService("TeleportService"):TeleportToPlaceInstance(game.placeId,_G.Job, game.Players.LocalPlayer)
		...
		Tabs.Ms:AddButton({
        Title = "Mở cửa hàng bán trái ác quỷ",
        Description = "",
        Callback = function()
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
...
"Tiki Outpost"},
    ...
    local Toggle = Tabs.Lc:AddToggle("MyToggle", {Title = "Bắt đầu dịch chuyển", Default = false })
...
NotificationLibrary:SendNotification("loading thành công", "chúc bn có 1 trải nghiệm thật tốt<3", 8)