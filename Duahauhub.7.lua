...
local Window = Fluent:CreateWindow({
    Title = "Duahau•Hub | Blox Fruits",
    SubTitle = " Make by Bảo An vip pro",
    TabWidth = 100,
...
local Tabs = {
    ...
    Qs = Window:AddTab({ Title = "Các loại farm khác", Icon = "" }), 
    stack = Window:AddTab({ Title = "Lấy tiem", Icon = "" }), 
    Se = Window:AddTab({ Title = "Săn sea", Icon = "" }),   
    St = Window:AddTab({ Title = "Chỉ số sv", Icon = "" }),    
    Lc = Window:AddTab({ Title = "Dịch chuyển", Icon = "" }),   
    spl = Window:AddTab({ Title = "Chỉ số", Icon = "" }),   
    RC = Window:AddTab({ Title = "Up v4", Icon = "" }),
    raid = Window:AddTab({ Title = "Định vị", Icon = "" }),
